...
/* Configure the app to use requirejs, and map dependency aliases to their
   ...
   support requirejs. */
require.config({
  baseUrl: 'sites/all/d1-dashboard-sixteen/js',
  paths: {
...
require(['backbone', 'bootstrap', 'routers/router', 'views/AppView', 'models/AppModel', 'collections/D1NodeList', 'collections/D1NodeStatusList'],
function(Backbone, Bootstrap, UIRouter, AppView, AppModel, D1NodeList, D1NodeStatusList) {
	'use strict';  

  appModel = new AppModel();
  
  // START DRUPAL CONTEXT CUSTOMIZATION
  var drupalContextPrefix = 'sites/all/d1-dashboard/';
  appModel.set('contextPrefix', drupalContextPrefix);
  // END DRUPAL CONTEXT CUSTOMIZATION
